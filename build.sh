...
echo "Building...
                ...
                "
g++ main.cpp UnitTest.cpp SquareFuncs.cpp Utils.cpp FuncsForRealNum.cpp -o a.out -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Wc++14-compat -Wmissing-declarations -Wcast-align -Wcast-qual \
